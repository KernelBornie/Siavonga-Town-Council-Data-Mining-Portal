...
const dlDir = path.resolve("public/downloads");
if (!fs.existsSync(dlDir)) {
  fs.mkdirSync(dlDir, { recursive: true });
}

fs.writeFileSync(
  path.join(dlDir, "db-unza26-csc4792-siavonga_scraper.ipynb"),
  JSON.stringify(notebook, null, 2)
);

console.log("Jupyter notebook generated in public/downloads/db-unza26-csc4792-siavonga_scraper.ipynb");
